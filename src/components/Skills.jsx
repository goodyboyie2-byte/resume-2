  ...
  return (
    <section id="skills" className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/3 right-0 w-96 h-96 bg-pink-500/10 rounded-full filter blur-3xl" />
        <div className="absolute bottom-1/3 left-0 w-96 h-96 bg-purple-500/10 rounded-full filter blur-3xl" />
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {skillCategories.map((category, index) => (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:border-purple-500/50 transition-all duration-300"
            >
